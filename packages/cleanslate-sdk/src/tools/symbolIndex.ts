...
export async function buildCleanSlateSymbolIndex(model: ISlateTextModel, context: CleanSlateToolContext): Promise<CleanSlateSymbolIndex> {
...
async function collectLanguageFeatureCandidates(model: ISlateTextModel, context: CleanSlateToolContext): Promise<CleanSlateSymbolIndexEntry[]> {
...
async function collectTreeSitterCandidates(model: ISlateTextModel, context: CleanSlateToolContext): Promise<CleanSlateSymbolIndexEntry[]> {
