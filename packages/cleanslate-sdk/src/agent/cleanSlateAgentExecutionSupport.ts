...
import { IMarkerHost, IMarker, MarkerSeverity } from '../host/diagnostics.js';
import { IWorkspaceHost } from '../host/workspace.js';
import { ICleanSlateContextService } from '../protocol/cleanSlateAI.js';

export class CleanSlateAgentExecutionSupport {
    constructor(
        private readonly workspaceContextService: IWorkspaceHost,
        private readonly markerService: IMarkerHost,
