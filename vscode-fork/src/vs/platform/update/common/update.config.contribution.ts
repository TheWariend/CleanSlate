...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'update.mode': {
			...
			description: localize('updateMode', "Configure whether you receive automatic CleanSlate updates. Requires a restart after change. Updates are fetched from the CleanSlate update service."),
			...
			enumDescriptions: [
				...
				localize('default', "Enable automatic update checks. CleanSlate will check for updates automatically and periodically.")
			],
			policy: {
				name: 'UpdateMode',
				...
				minimumVersion: '1.67',
				localization: {
					description: { key: 'updateMode', value: localize('updateMode', "Configure whether you receive automatic CleanSlate updates. Requires a restart after change. Updates are fetched from the CleanSlate update service."), },
					enumDescriptions: [
						{
							key: 'none',
						...
						{
							key: 'default',
							value: localize('default', "Enable automatic update checks. CleanSlate will check for updates automatically and periodically."),
						}
					]
				},
			}
		...
		'update.enableWindowsBackgroundUpdates': {
			...
			description: localize('enableWindowsBackgroundUpdates', "Enable to download and install new CleanSlate versions in the background on Windows."),
