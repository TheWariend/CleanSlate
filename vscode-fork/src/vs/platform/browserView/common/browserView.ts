...
export interface IBrowserViewMouseEvent {
...
export interface IBrowserViewService {
	 ...
	 */
	getOrCreateBrowserView(id: string, scope: BrowserViewStorageScope, workspaceId?: string, sessionGroupId?: string): Promise<IBrowserViewState>;
	...
	/**
	 * Reorder a browser view above sibling native views in its owning window.
	 * @param id The browser view identifier
	 */
	...
	/**
	 * Dispatch a mouse event to the browser view
	 * @param id The browser view identifier
	 * @param mouseEvent The mouse event data
	 */
	dispatchMouseEvent(id: string, mouseEvent: IBrowserViewMouseEvent): Promise<void>;
	moveMouse(id: string, x: number, y: number): Promise<void>;

	/**
	 * Insert text into the currently focused browser view element
	 * @param id The browser view identifier
	...
	/**
	 * Execute JavaScript in the browser view isolated world.
	 * @param id The browser view identifier
	...
	/**
	 * Return bounded console and network activity captured from this exact browser view.
	 */
	getDiagnostics(id: string, clear?: boolean): Promise<IBrowserViewDiagnostics>;

	/**
	 * Assign local files to a file input in this browser view through Chromium's DOM protocol.
	 */
	setFileInputFiles(id: string, selector: string, files: string[]): Promise<void>;
	handleJavaScriptDialog(id: string, accept: boolean, promptText?: string): Promise<void>;
