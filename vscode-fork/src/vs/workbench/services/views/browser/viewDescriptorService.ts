...
import { ViewContainerLocation, IViewDescriptorService, IViewContainerModel, ViewContainer, IViewsRegistry, IViewContainersRegistry, IViewDescriptor, Extensions as ViewExtensions, ViewVisibilityState, defaultViewIcon, ViewContainerLocationToString, VIEWS_LOG_ID, VIEWS_LOG_NAME } from '../../../common/views.js';
...
export class ViewDescriptorService extends Disposable implements IViewDescriptorService {
	...
	private addViews(container: ViewContainer, views: IViewDescriptor[], visibilityState: ViewVisibilityState = ViewVisibilityState.Default): void {
		...
		(this.getViewContainerModel(container) as ViewContainerModel).add(views.map(view => {
			return {
				viewDescriptor: view,
	...
	private removeViews(container: ViewContainer, views: IViewDescriptor[]): void {
		...
		// Remove the views
		(this.getViewContainerModel(container) as ViewContainerModel).remove(views);
	}
