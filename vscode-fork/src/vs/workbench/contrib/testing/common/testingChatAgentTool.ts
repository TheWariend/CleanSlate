...
class RunTestTool implements IToolImpl {
	...
	public static readonly DEFINITION: IToolData = {
		...
		tags: [
			...
			'enable_other_tool_ai_readFile',
			'enable_other_tool_ai_listDirectory',
			'enable_other_tool_ai_findFiles',
			'enable_other_tool_ai_runTests',
			'enable_other_tool_ai_runTestsWithCoverage',
			'enable_other_tool_ai_testFailure',
		],
	};
