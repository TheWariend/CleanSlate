...
class QuickChat extends Disposable {
	...
	private setupDisclaimer(parent: HTMLElement): void {
		...
		this._register(autorun(reader => {
			...
			if (showDisclaimer) {
				const renderedMarkdown = disposables.add(this.markdownRendererService.render(new MarkdownString(localize('termsDisclaimer', "By continuing, you agree to the Terms and Privacy Statement."), { isTrusted: true })));
