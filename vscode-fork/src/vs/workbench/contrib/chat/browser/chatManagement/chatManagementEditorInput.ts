...
const ChatManagementEditorIcon = registerIcon('ai-management-editor-label-icon', Codicon.ai, nls.localize('aiManagementEditorLabelIcon', 'Icon of the AI Management editor label.'));
...
export class ChatManagementEditorInput extends EditorInput {
	...
	override getName(): string {
		return nls.localize('aiManagementEditorInputName', "Manage AI");
	}
