...
export enum AgentFileType {
	agentsMd = 'agentsMd',
	claudeMd = 'claudeMd',
	aiInstructionsMd = 'aiInstructionsMd',
}
...
export interface IPromptsService extends IDisposable {
	...
	/**
	 * Gets list of agent instruction files (AGENTS.md, CLAUDE.md, ai-instructions.md).
	 * Combines results from listAgentMDs (non-nested), listClaudeMDs, and listAIInstructionsMDs.
	 */
	listAgentInstructions(token: CancellationToken, logger?: Logger): Promise<IResolvedAgentFile[]>;

	/**
	 * Gets list of nested AGENTS.md files in the workspace.
	 */
