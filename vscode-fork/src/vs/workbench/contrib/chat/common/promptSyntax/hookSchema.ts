...
/**
 * JSON Schema for CleanSlate AI hook configuration files.
...
export const hookFileSchema: IJSONSchema = {
	...
	type: 'object',
	description: nls.localize('hookFile.description', 'CleanSlate AI hook configuration file. Hooks enable executing custom shell commands at strategic points in an agent\'s workflow.'),
	additionalProperties: false,
 ...
 * Only matches exact enum values. For tool-specific naming conventions (e.g., Claude, AI CLI),
