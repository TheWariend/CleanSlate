	...
	testT('core logic', async () => {
		...
		assertOutcome(
			...
			[
				...
				'/Users/legomushroom/repos/prompts/refactor-tests.prompt.md',
				'/tmp/prompts/translate.to-rust.prompt.md',
				'/Users/legomushroom/repos/vscode/.ai/prompts/default.prompt.md',
			],
			'Must find correct prompts.',
		);
		await locator.disposeAsync();
			...
			suite('absolute', () => {
				...
				testT(`specific`, async () => {
					const testSettings = [
						...
						[
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/my.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/*specific*',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/*common*',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/my.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/*specific*.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/*common*.prompt.md',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/my*.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/*specific*.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/*common*.md',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/my*.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/specific*',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/unspecific*',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/common*',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/uncommon*',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/my.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/specific.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/unspecific1.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/unspecific2.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/common.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,ai}/{gen,general}/**/uncommon-10.prompt.md',
						],
					];
