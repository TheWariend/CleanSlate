...
suite('PromptHoverProvider', () => {
	...
	suite('agent hovers', () => {
		test('hover on target attribute shows description', async () => {
			...
			assert.strictEqual(hover, 'The target to which the header attributes like tools apply to. Possible values are `cleanslate-ai` and `vscode`.');
		});

		test('hover on model attribute with cleanslate-ai target shows note', async () => {
			const content = [
				'---',
				'description: "Test"',
			...
			const expected = [
				...
				'',
				'Note: This attribute is not used when target is cleanslate-ai.'
			].join('\n');
		...
		test('hover on handoffs attribute with cleanslate-ai target shows note', async () => {
			const content = [
				'---',
				'description: "Test"',
				'target: cleanslate-ai',
		...
		test('hover on cleanslate-ai tool shows simple description', async () => {
			const content = [
				'---',
				'description: "Test"',
				'target: cleanslate-ai',
		...
		test('hover on cleanslate-ai tool with target undefined', async () => {
			const content = [
				'---',
				'name: "Test"',
				'description: "Test"',
