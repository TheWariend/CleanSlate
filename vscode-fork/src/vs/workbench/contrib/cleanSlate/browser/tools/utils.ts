 ...
 */
function getIdeWorkspaceContextService(context: CleanSlateToolContext): IWorkspaceContextService | undefined {
 ...
 */
export async function resolveTextModelHeadless(uri: URI, context: CleanSlateToolContext): Promise<ITextModel | null> {
