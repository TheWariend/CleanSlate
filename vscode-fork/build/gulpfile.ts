...
import { compileExtensionMediaTask, compileExtensionsSerialTask, compileExtensionsTask, watchExtensionsTask } from './gulpfile.extensions.ts';
...
// Diagnostic compile: same coverage as "compile", but serial extension compilation surfaces failing target quickly.
const compileDiagnosticTask = task.define('compile-diagnostic', task.series(monacoTypecheckTask, compileClientTask, compileExtensionsSerialTask, compileExtensionMediaTask));
gulp.task(compileDiagnosticTask);
