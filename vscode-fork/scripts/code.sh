...
function code() {
	...
	# Block proprietary Copilot extensions from loading in CleanSlate
	DISABLE_COPILOT="--disable-extension=GitHub.copilot --disable-extension=GitHub.copilot-chat"

	# Launch Code
	exec "$CODE" . $DISABLE_TEST_EXTENSION $DISABLE_COPILOT "$@"
}
