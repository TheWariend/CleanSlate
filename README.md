...
The current release is **CleanSlate 1.0.7**. See the [release notes](https://github.com/TheWariend/CleanSlate-Releases/releases/tag/v1.0.7) or download it directly:
