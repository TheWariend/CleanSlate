...
The current release is **CleanSlate 1.0.12**. See the [release notes](https://github.com/TheWariend/CleanSlate-Releases/releases/tag/v1.0.12) or download it directly:
...
| [`@cleanslate/sdk`](https://www.npmjs.com/package/@cleanslate/sdk) | `1.0.11` · ![npm](https://img.shields.io/npm/v/@cleanslate/sdk?style=flat-square&label=npm) |
