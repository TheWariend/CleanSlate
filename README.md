...
The current release is **CleanSlate 1.0.8**. See the [release notes](https://github.com/TheWariend/CleanSlate-Releases/releases/tag/v1.0.8) or download it directly:
